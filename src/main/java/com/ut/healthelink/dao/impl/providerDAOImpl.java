...
import com.ut.healthelink.dao.providerDAO;
...
/**
 * The providerDAOImpl class will implement the DAO access layer to handle updates for organization providers
 *
 *
 * @author chadmccue
 *
...
public class providerDAOImpl implements providerDAO {
    ...
    /**
     * The 'updateProvider' function will update the selected provider with the changes entered into the form.
     *
    ...
    /**
     * The 'getProviderById' function will return a single provider object based on the providerId passed in.
     *
    ...
    /**
     * The 'deleteProvider' function will delete the provider based on the providerId passed in.
     *
     * @param	providerId	This will be id to find the specific provider
     *
     * @return	The function does not return anything
    ...
    /**
     * The 'findProviders' function will return a list of provider objects based on a specific organization Id and a search term. The search will look for providers for a specific organization and whose first name or last name match the search term provided.
     *
     * @param	orgId	This will be the orgId used to find providers searchTerm. This will be used to query the firstname field and lastname field
     *
    ...
    /**
     * The 'getProviderAddresses' function will return a list of addresses associated with the selected provider.
     *
    ...
    /**
     * The 'updateAddress' function will update the selected address with the changes entered into the form.
     *
    ...
    /**
     * The 'createAddress' function will submit the new address entered into the form.
     *
     * @param	systemAddress	This will hold the address object from the address form
     *
     * @return the function does not return anything
    ...
    /**
     * The 'deleteAddress' function will delete the provider address on the addressId passed in.
     *
    ...
    /**
     * The 'getProviderIds' function will return a list of ids associated with the selected provider.
     *
    ...
    /**
     * The 'updateId' function will update the selected id with the changes entered into the form.
     *
    ...
    /**
     * The 'createId' function will submit the new id entered into the form.
     *
