...
import com.ut.healthelink.security.CustomWebAuthenticationDetails.MyAuthenticationDetails;
...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(final Authentication authentication) throws AuthenticationException {
        ...
        com.ut.healthelink.model.User user = usermanager.getUserByUserName(name);
        com.ut.healthelink.model.User loginUserInfo = user;
