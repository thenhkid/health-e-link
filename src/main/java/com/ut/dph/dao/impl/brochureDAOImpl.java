...
public class brochureDAOImpl implements brochureDAO {
	...
	/**
	 * The 'updateBrochure' function will update the selected brochure with the changes
	...
	/**
	 * The 'getBrochureById' function will return a single brochure object based on the brochureId
	 * passed in.
	 * 
	...
	/**
	 * The 'findBrochures' function will return a list of brochure objects based on a specific 
	 * organization Id and a search term. The search will look for brochures for a specific
	 * organization and whose title or file name match the search term provided.
	 * 
	 * @param	orgId		This will be the orgId used to find providers
	 * 			searchTerm	This will be used to query the title and file name field
	 * 
