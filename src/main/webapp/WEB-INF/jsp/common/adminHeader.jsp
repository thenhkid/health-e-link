        ...
        <div class="contain">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav" role="menu">
                    ...
                    <li role="menuitem" class="${param['sect'] == 'activities' ? 'active' : 'none'}"><a href="<c:url value='/administrator/processing-activities' />" title="Processing Activities">Processing Activities</a><c:if test="${param['sect'] == 'activities'}"><span class="indicator-active arrow-up"></span></c:if></li>
