        ...
        <div class="contain">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav" role="menu">
                    ...
                    <li role="menuitem" class="${param['sect'] == 'activity' ? 'active' : 'none'}"><a href="<c:url value='/administrator/processing-activity' />" title="Processing Activity">Processing Activity</a><c:if test="${param['sect'] == 'activity'}"><span class="indicator-active arrow-up"></span></c:if></li>
