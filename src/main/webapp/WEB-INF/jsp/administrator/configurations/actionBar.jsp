        ...
        <ul class="nav navbar-nav navbar-right navbar-actions">
            <c:choose>
                <c:when test="${param['page'] == 'listConfigs'}">
                    ...
                    <li><a href="<c:url value='/administrator/configurations/list' />" title="Cancel" role="button"><span class="glyphicon icon-stacked glyphicon-ban-circle"></span>Cancel</a></li>
                    </c:otherwise>
                </c:choose>
        </ul>
    </div>
