...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
        <ul class="nav nav-pills nav-stacked nav-steps">
            ...
            <li ${param['page'] == 'schedule' ? 'class="active"' : ''} ${id > 0 and completedSteps >= 5 ? '' : 'class="disabled"'}><a href="${param['page'] != 'schedule' and id > 0 and completedSteps >= 5 ? 'scheduling' : 'javascript:void(0);'}" title="Step 6: Scheduling"><span class="badge">6</span> Scheduling</a></li>
        </ul>
    </nav>
</aside>
