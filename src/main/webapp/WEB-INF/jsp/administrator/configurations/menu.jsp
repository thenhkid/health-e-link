...
<aside class="secondary">
    <nav class="secondary-nav" role="navigation">
        <ul class="nav nav-pills nav-stacked nav-steps" role="menu" >
            ...
            <li role="menuitem" ${param['page'] == 'specs' ? 'class="active"' : ''} ${id > 0 and stepsCompleted >= 2 and configurationDetails.type == 1 ? '' : 'class="disabled"'}><a href="${param['page'] != 'specs' and id > 0 and stepsCompleted >= 2 and configurationDetails.type == 1 ? 'messagespecs' : 'javascript:void(0);'}" title="Detail Message Specs">Message Specs</a></li>
