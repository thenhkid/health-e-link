								    ...
								    <c:forEach var="brochure" items="${brochureList}">
										<tr id="userRow">
											...
											<td class="actions-col">
												...
												<a href="#brochureAttachment" data-toggle="modal" rel="view?i=${brochure.id}" class="btn btn-link brochureView" title="View this brochure">
												     <span class="glyphicon glyphicon-edit"></span>
												     View	
												</a>
...
<div class="modal fade" id="brochureAttachment" role="dialog" tabindex="-1" aria-labeledby="Brochure Attachment" aria-hidden="true" aria-describedby="Brochure Attachment"></div>
...
<script>
	...
	jQuery(document).ready(function($) {
		...
		//This function will remvoe the clicked brochure and will remove the 
