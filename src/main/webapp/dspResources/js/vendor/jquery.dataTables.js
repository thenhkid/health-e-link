                    ...
                    function($) {
                        ...
                        var DataTable = function(oInit)
                        {
                            ...
                            function _fnFeatureHtmlLength(oSettings)
                            {
                                ...
                                var sStdMenu = '<select ' + sName + ' style="width:100px" class="form-control">';
                                var i, iLen;
                                        ...
                                        typeof aLengthMenu[1] === 'object')
                                {
                                    ...
                                    {
                                        sStdMenu += '<option value="' + aLengthMenu[0][i] + '">' + aLengthMenu[1][i] + ' records </option>';
                                    }
                                } else
                                {
                                    for (i = 0, iLen = aLengthMenu.length; i < iLen; i++)
                                    {
                                        sStdMenu += '<option value="' + aLengthMenu[i] + '">' + aLengthMenu[i] + ' records</option>';
                                    }
                                }
                                sStdMenu += '</select>';
                            ...
                            this.$ = function(sSelector, oOpts)
                            {
                                ...
                                {
                                    for (i = oSettings._iDisplayStart, iLen = oSettings.fnDisplayEnd();
                                            i < iLen;
                                            i++)
                                    {
